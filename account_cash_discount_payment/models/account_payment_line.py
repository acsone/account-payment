...
class PaymentLine(models.Model):
    ...
    def _compute_discount_amount(self):
        for rec in self:
            # TODO: can be computed on account_move_line
    ...
    def _onchange_pay_with_discount(self):
        ...
        if self.pay_with_discount:
            # apply discount
            self.amount_currency = invoice_line._get_amount_after_discount()
        else:
    ...
    def _onchange_amount_with_discount(self):
        ...
        amount_with_discount = invoice_line._get_amount_after_discount()
