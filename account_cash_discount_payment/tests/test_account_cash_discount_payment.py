...
class TestAccountCashDiscountPaymentCommon(TransactionCase):
    ...
    def test_invoice_payment_refund_and_discount(self):
        ...
        # (refund+invoice).invoice_line_ids.reconcile()
        ...
        self.assertAlmostEqual(payment_line.discount_amount, 23.00, 2)
        self.assertAlmostEqual(payment_line.amount_currency, 69.00, 2)
